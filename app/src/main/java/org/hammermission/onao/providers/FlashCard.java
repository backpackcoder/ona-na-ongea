...
public final class FlashCard {
    ...
    static final String MATCH_ALL_ROWS_MIME =
            String.format("vnd.android.cursor.dir/vnd.{0}.{1}", AUTHORITY, TABLE);

    static final int MATCH_SINGLE_ROW = 2;
    static final String MATCH_SINGLE_ROW_PATH = String.format("{0}/#", TABLE);
    static final String MATCH_SINGLE_ROW_MIME =
            String.format("vnd.android.cursor.item/vnd.{0}.{1}", AUTHORITY, TABLE);

    static final int MATCH_IMAGE = 3;
    static final String MATCH_IMAGE_PATH = String.format("{0}/#/image", TABLE);
    static final String MATCH_IMAGE_MIME = "image/png";

    static final int MATCH_AUDIO = 4;
    static final String MATCH_AUDIO_PATH = String.format("{0}/#/audio", TABLE);
